<<<<<<< HEAD
function dat = Behavior_Datapaths(pathBehavior,verbose)
% USAGE: dat = Behavior_Datapaths(pathBehavior,verbose)
=======
function dat = Behavior_Datapaths(dataPath,verbose)
% USAGE: dat = Behavior_Datapaths(dataPath,verbose)
>>>>>>> 7b9875408f2a837e8db3807b3bb54bc2ea0cb63c
%
...
if nargin<1
<<<<<<< HEAD
    pathBehavior='C:Neuroscience/Writing/00Code-Data/';
=======
...
%% Rat_07
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-01-15-131211.txt');
dat.pre2.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-01-16-143109.txt');
dat.pre3.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-01-22-134106.txt');
dat.pre4.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-01-23-140549.txt');
dat.pre5.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-01-30-121128.txt');
dat.pre6.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-02-05-110821.txt');
dat.pre7.(dat.ratIDs{1})=cat(2,pathBehavior,datafolders{1},'/3907L-2020-02-06-125652.txt');
=======
...
%% Rat_08
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-01-15-131211.txt');
dat.pre2.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-01-16-143109.txt');
dat.pre3.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-01-22-134106.txt');
dat.pre4.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-01-23-140549.txt');
dat.pre5.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-01-30-121128.txt');
dat.pre6.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-02-05-110821.txt');
dat.pre7.(dat.ratIDs{2})=cat(2,pathBehavior,datafolders{2},'/3908LR-2020-02-06-125652.txt');
=======
...
%% Rat_10
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{3})=cat(2,pathBehavior,datafolders{3},'/3910LR-2020-01-15-131211.txt');
dat.pre2.(dat.ratIDs{3})=cat(2,pathBehavior,datafolders{3},'/3910LR-2020-01-16-143109.txt');
dat.pre3.(dat.ratIDs{3})=cat(2,pathBehavior,datafolders{3},'/3910LR-2020-01-22-134106.txt');
dat.pre4.(dat.ratIDs{3})=cat(2,pathBehavior,datafolders{3},'/3910LR-2020-01-23-140549.txt');
dat.pre5.(dat.ratIDs{3})=cat(2,pathBehavior,datafolders{3},'/3910LR-2020-02-06-125652.txt');


%% Rat_11
dat.pre1.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-01-15-102530.txt');
dat.pre2.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-01-16-112935.txt');
dat.pre3.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-01-23-114935.txt');
dat.pre4.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-01-30-134021.txt');
dat.pre5.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-02-05-123033.txt');
dat.pre6.(dat.ratIDs{4})=cat(2,pathBehavior,datafolders{4},'/3911L-2020-02-06-142422.txt');
=======
...
%% Rat_12
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-01-15-102530.txt');
dat.pre2.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-01-16-112935.txt');
dat.pre3.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-01-22-111354.txt');
dat.pre4.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-01-23-114935.txt');
dat.pre5.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-01-30-134021.txt');
dat.pre6.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-02-05-123033.txt');
dat.pre7.(dat.ratIDs{5})=cat(2,pathBehavior,datafolders{5},'/3912LR-2020-02-06-142422.txt');
=======
...
%% Rat_13
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-01-15-102530.txt');
dat.pre2.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-01-16-112935.txt');
dat.pre3.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-01-23-114935.txt');
dat.pre4.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-01-30-134021.txt');
dat.pre5.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-02-05-123033.txt');
dat.pre6.(dat.ratIDs{6})=cat(2,pathBehavior,datafolders{6},'/3913L-2020-02-06-142422.txt');
=======
...
%% Rat_14
<<<<<<< HEAD
dat.pre1.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-01-15-102530.txt');
dat.pre2.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-01-16-112935.txt');
dat.pre3.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-01-22-111354.txt');
dat.pre4.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-01-23-114935.txt');
dat.pre5.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-01-30-134021.txt');
dat.pre6.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-02-05-123033.txt');
dat.pre7.(dat.ratIDs{7})=cat(2,pathBehavior,datafolders{7},'/3914LR-2020-02-06-142422.txt');


%% Rat_15
dat.pre1.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-01-21-150547.txt');
dat.pre2.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-01-16-132652.txt');
dat.pre3.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-01-22-123551.txt');
dat.pre4.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-01-23-130438.txt');
dat.pre5.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-01-30-151838.txt');
dat.pre6.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-02-05-141948.txt');
dat.pre7.(dat.ratIDs{8})=cat(2,pathBehavior,datafolders{8},'/3915L-2020-02-05-141948.txt');


%% Rat_16
dat.pre1.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-01-15-120420.txt');
dat.pre2.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-01-16-160717.txt');
dat.pre3.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-01-22-123551.txt');
dat.pre4.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-01-23-130438.txt');
dat.pre5.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-01-30-151838.txt');
dat.pre6.(dat.ratIDs{9})=cat(2,pathBehavior,datafolders{9},'/3916LR-2020-02-05-141948.txt');

%% Rat_17
dat.pre1.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-01-15-120420.txt');
dat.pre2.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-01-16-132652.txt');
dat.pre3.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-01-22-123551.txt');
dat.pre4.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-01-23-130438.txt');
dat.pre5.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-01-30-151838.txt');
dat.pre6.(dat.ratIDs{10})=cat(2,pathBehavior,datafolders{10},'/3917L-2020-02-06-160351.txt');


%% Rat_18
dat.pre1.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-01-15-120420.txt');
dat.pre2.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-01-16-132652.txt');
dat.pre3.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-01-22-123551.txt');
dat.pre4.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-01-23-130438.txt');
dat.pre5.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-01-30-151838.txt');
dat.pre6.(dat.ratIDs{11})=cat(2,pathBehavior,datafolders{11},'/3918LR-2020-02-05-141948.txt');


%% Rat_19
dat.pre1.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-01-15-142435.txt');
dat.pre2.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-01-16-160717.txt');
dat.pre3.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-01-22-152603.txt');
dat.pre4.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-01-23-151928.txt');
dat.pre5.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-01-30-162823.txt');
dat.pre6.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-02-05-154031.txt');
dat.pre7.(dat.ratIDs{12})=cat(2,pathBehavior,datafolders{12},'/3919L-2020-02-06-171321.txt');


%% Rat_20
dat.pre1.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-01-15-142435.txt');
dat.pre2.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-01-16-160717.txt');
dat.pre3.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-01-22-152603.txt');
dat.pre4.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-01-23-151928.txt');
dat.pre5.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-01-30-162823.txt');
dat.pre6.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-02-05-154031.txt');
dat.pre7.(dat.ratIDs{13})=cat(2,pathBehavior,datafolders{13},'/3920LR-2020-02-06-171321.txt');
=======
